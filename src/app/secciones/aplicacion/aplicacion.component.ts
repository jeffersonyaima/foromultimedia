...
export class AplicacionComponent implements OnInit {
  ...
  filesAplicaciones=this.firestoreService.array_archivosAplicacion;
  ...
  constructor(private authSvc: AuthService, private firestoreService: FirestoreService, private readonly firestore: AngularFirestore,
    ...
    this.firestore.collection('secciones').doc('aplicacion').get().subscribe((resultado)=>{
  ...
  actualizarDescripcion(){
    ...
    this.firestore.collection('secciones').doc('aplicacion').update({
