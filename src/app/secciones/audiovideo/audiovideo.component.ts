...
export class AudiovideoComponent implements OnInit {
  ...
  filesAudio=this.firestoreService.array_archivosAudio;
  ...
  constructor(private authSvc: AuthService, private firestoreService: FirestoreService, private readonly firestore: AngularFirestore,
    ...
    this.firestore.collection('secciones').doc('audiovideo').get().subscribe((resultado)=>{
  ...
  actualizarDescripcion(){
    ...
    this.firestore.collection('secciones').doc('audiovideo').update({
