...
export class ProgramacionComponent implements OnInit {
  ...
  filesProgramacion=this.firestoreService.array_archivosProgramacion;
  ...
  actualizarDescripcion(){
    ...
    this.firestore.collection('secciones').doc('programacion').update({
  ...
  startUpload(file:File) {
    ...
    this.snapshot   = this.task.snapshotChanges().pipe(
      ...
      finalize( async() =>  {
        ...
        window.open('/programacion', "_self");
